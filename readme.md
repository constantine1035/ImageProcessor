...
Этот проект представляет из себя консольное приложение,
...
Формат BMP поддерживает достаточно много вариаций, но в этом проетке используется 24-битный BMP.
...
4. Полученное изображение сохраняется в файл `/tmp/output.bmp`
...
#### Также были реализованы некоторые другие фильтры
